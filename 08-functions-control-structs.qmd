...
You can download a template Quarto file to start from [here](activity_templates/08-functions-control-structs.qmd). Save this template within the following directory structure:
