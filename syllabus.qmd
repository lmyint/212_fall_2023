...
I'll be setting times for drop-in hours based on feedback from the pre-course survey. I'll update my drop-in hours here when they're finalized.
...
- **Self-reflection:**
    ...
    - I will look at the **consistency** in your reflection process by monitoring your [Process and Reflection Google Doc](https://docs.google.com/document/d/1tyyuYNXpzqMxw2osGnM_9I5ivBj3a0iSZ_LVZusDqY8/edit?usp=sharing).
...
- **Homework:** We will have weekly homework in which you will complete activities that we start in class. The requirements for passing the assignment will be clearly stated in the homework directions.
    - If you do not pass an assignment and wish to revise your work, you may resubmit the assignment the **following week**. This revision needs to be submitted by 2 weeks after the original homework due date. (See my [policy on late work](syllabus.qmd#late-work).)
...
::: {.callout-note title="Comparing Options 1 and 2"}
