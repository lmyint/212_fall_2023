...
subtitle: "(Version BEFORE student input on learning goals and grading system)"
---
...
- After joining, you can access our workspace [here](https://statcomp212fall2023.slack.com). (You might want to bookmark this if you have Slack open in your web broswer.)
...
- **Homework:** We will have weekly homework in which you will complete activities that we start in class. The requirements for passing the assignment will be clearly stated in the homework directions.
    - If you do not pass an assignment and wish to revise your work, you may resubmit the assignment the **following week**. This revision needs to be submitted by 2 weeks after the original homework due date. (See my [policy on late work](syllabus_prelim.qmd#late-work).)
